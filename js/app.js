...
function iconoSvgBotonEspecial(tipo){
  const svg = {
    ...
    VENTA:'<svg viewBox="0 0 24 24"><path d="M20 13 11 4H4v7l9 9a2 2 0 0 0 2.8 0l4.2-4.2A2 2 0 0 0 20 13Z"/><circle cx="7.5" cy="7.5" r="1.3"/><path d="m15.5 7 .7 1.8L18 9.5l-1.8.7-.7 1.8-.7-1.8-1.8-.7 1.8-.7.7-1.8Z"/></svg>'
  };
