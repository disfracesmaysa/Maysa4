...
function iconoSvgBotonEspecial(tipo){
  const svg = {
    ...
    VENTA:'<svg viewBox="0 0 24 24"><path d="m12 3-1.2 3.8L7 8l3.8 1.2L12 13l1.2-3.8L17 8l-3.8-1.2L12 3Z"/><path d="m5 14-.8 2.2L2 17l2.2.8L5 20l.8-2.2L8 17l-2.2-.8L5 14Zm14-2-1 3-3 1 3 1 1 3 1-3 3-1-3-1-1-3Z"/></svg>'
  };
